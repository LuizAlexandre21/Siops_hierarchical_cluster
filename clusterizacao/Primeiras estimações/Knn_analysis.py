...
axs[0].scatter(X_test[:,0], X_test[:,1], c=classifier.classes_)
axs[1].scatter(X_test[:,1],X_test[:,2],c=classifier.classes_)
axs[2].scatter(X_test[:,2],X_test[:,0],c=classifier.classes_)
plt.show()