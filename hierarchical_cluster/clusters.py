...
def Agglomerative(X_train, X_test):
    ...
    # Prevendo os modelos 
    X_pred = classifier.fit_predict(X_test)

    return X_pred 

# Spectral Clustering
def Spectral(X_train, X_test):
    # GridSearch
    # Parametros
    params = {
